                ...
                $.each(this, function(k, v) {
                  $.each(this, function(a, b) {
                      ...
                      if(b == null || b == ''){
                        ...
                        catHtml = catHtml + "<li><a href='javascript:void(0)' onclick='javascript:document.CatalogSearchForm.searchTerm.value=\""+category[0]+"\"; document.CatalogSearchForm.submit();' title='"+category[0]+"'>"+category[0]+"</a><ul>";
                        $.each(this, function(x, y) {
                          $.each(this, function(c, d) {
                            $.each(this, function(e, f) {
                              var sNameClean = e.replace(/[']+/g,'');
                              subCatHtml = subCatHtml + "<li><a href='/"+sNameClean+"/_/"+f+"?taCategory="+sNameClean+"&taSearchTerm="+searchText+"' title='"+e+"'>in "+e+"</a></li>";
                            });
                          });
                        });
