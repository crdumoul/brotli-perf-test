...
*********************************************************************
**	Revision History:
**	JC: 2/10/10 Changed the value of s.visitorNamespace to be "drsfosterandsmith"
**		instead of "doctorfostersmith".
**	JC: 12/5/2011 Removed Marin code.
**	MZ: 03/27/12 added Google Referrer Change Patch v1.1
********************************************************************/ 

/* Specify the Report Suite ID(s) to track here */
var s_account="dfsprod"
...
s.linkInternalFilters="javascript:,drsfostersmith.com,fosterandsmithaquatics.com,liveaquaria.com,peteducation.com,etropicals.com,ferretstore.com,"
...
s.visitorNamespace="drsfosterandsmith"
s.dc=112
...
function s_doPlugins(s) {
	...
	/* Code to Capture Looksmart Source Codes */
	if(!s.eVar18) 
		s.eVar18=s.getQueryParam('source');
		
	if(s.campaign){
		s.eVar7=s.campaign;
		s.eVar8=s.campaignStacking(s.campaign,'s_cpm','90','5','>','purchase');
	}
	...
	if(s.eVar3&&s.eVar3!='browse')
		s.eVar4='non-browse'
	
	/* Set non-internal campaign variable */
	if(s.eVar3&&s.eVar3!='internal campaign'&&!s.eVar1)
...
//s.loadModule("Media")
/* MJS: set s.media.autotrack to true for autoTrack to work in Flash*/
...
/* Uncomment after 1st Party cookie installed  */
/* ONLY ON LIVE  */
s.trackingServer="metric.drsfostersmith.com"
s.trackingServerSecure="metrics.drsfostersmith.com"
...
/* campaignStacking Example: 1.1                                                          
 *                                                                                        
 * List of Parameters:                                                                    
 * vu-variable to stack values from                                                       
 * cn-name of cookie to stack values in                                                   
 * ex-expiration of campaign value in days                                                   
 * ct-number of distinct values to store in cookie                                        
 * dl-delimiter to display in variable                                                         
 * ev-success event(s) which clear cookie (use comma seperated list)                        
 *                                                                                        
 */
 
s.campaignStacking = new Function("v","cn","ex","ct","dl","ev",""                          
