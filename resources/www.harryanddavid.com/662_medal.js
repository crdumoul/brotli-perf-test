    ...
    app = {
        ...
        tplVars: {
            images: {
                ...
                paths: {
                    body: ['cdn', 'medals/summary/' + 662 + '_medal_summary.gif'],
            ...
            registeredText: '',
            participatingText: '',
            target: 'http://www.bizrate.com/ratings_guide/merchant_detail__mid--' + 662 + '.html?rf=sur',
            certified: true,
			MID: '662',		
	    ...
	    setShowMouseOver: function () {
	    	...
	    	safeMerchantName = this.escapeString("Harry and David");
