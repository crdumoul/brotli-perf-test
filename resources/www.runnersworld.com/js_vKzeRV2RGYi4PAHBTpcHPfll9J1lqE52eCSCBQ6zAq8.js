(function ($) {
	Drupal.behaviors.zeus_video_embed = {
	  attach: function(context) {
	    $('.view-ckeditor-video-embed tr td').click(function() {
	    	$('.view-ckeditor-video-embed tr td').removeClass('active');
	    	var classes = $(this).attr('class').split(' ');
	    	for (var i=0; i<classes.length; i++) {
	    		var nid = classes[i].match(/\d+/); 
			}
			$(this).addClass('active');  
			window.parent.zeusVideoEmbedNid = nid;
	    });
	  }
	}
})(jQuery);
