...
if (typeof mboxVersion == 'undefined') {
    ...
    var mboxFactoryDefault = new mboxFactory('dollarthriftyautomot.tt.omtrdc.net', 'dollarthriftyautomot', 'default');
};
if (mboxGetPageParameter("mboxDebug") != null || mboxFactoryDefault.getCookieManager().getCookie("debug") != null) {
    ...
    document.write('<' + 'scr' + 'ipt language="Javascript1.2" src=' + '"http://admin9.testandtarget.omniture.com/admin/mbox/mbox_debug.jsp?mboxServerHost=dollarthriftyautomot.tt.omtrdc.net' + '&clientCode=dollarthriftyautomot"><' + '\/scr' + 'ipt>');
};
