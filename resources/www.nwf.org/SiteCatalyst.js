var reDev = /^(localhost|hq-scprod|blzorig|backstage)/i;
...
function s_doPlugins(s) {
	...
	/* Search Terms -- Obsolete as of 6/2012: moved this into sitecore */
	//if (s.prop1) {
	...
	if (!s.eVar2) {
	    s.eVar2 = s.getQueryParam('cds_response_key');
	}
    ...
    // 8/19/2013 DFR: Special handling for CDS pages per MEMCO-293.
	if (window.location.href.toLowerCase().match("w1.buysub.com")) {
	    s.channel = "CDS";
	    s.prop9 = "CDS";
	    s.eVar9 = "CDS";
	    var cds_mag_code = s.getQueryParam('cds_mag_code');
	    s.prop10 = "CDS:" + cds_mag_code;
	    s.eVar10 = "CDS:" + cds_mag_code;
	    var cds_page_id = s.getQueryParam('cds_page_id');
	    s.prop11 = "CDS:" + cds_mag_code + ":" + cds_page_id;
	    s.eVar11 = "CDS:" + cds_mag_code + ":" + cds_page_id;
	}
