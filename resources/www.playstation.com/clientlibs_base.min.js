...
g(window).on("resize.pdcYTColorBox",function(){g("#colorbox").css("overflow","visible");
g.colorbox.resize({height:l,width:e})
});
g(window).trigger("resize.pdcYTColorBox")
},onClosed:function(){g(window).off("resize.pdcYTColorBox")
}});
...
var F=false;
if(H.hasClass("link-btn")){if(q){F=true
}else{G.width="800px";
G.height="600px"
...
if(document.location.href.toString().match(/en(_CA|-ca)\//)){var platform=null;
var title=null;
var upc=null;
var gtin=null;
$("meta").each(function(){var c=$(this);
var b=c.attr("name");
var a=c.attr("content");
if(b=="gameTitle"){title=a
}else{if(b=="SKU-ID"){upc=a
}else{if(b=="platform"){platform=a
}}}});
if(title!==null&&platform!==null&&upc!==null){var _afshquery="'"+title.replace(/&[\w]+;/,"").replace(/[^\w\s_!?-]+/,"")+"' "+platform+" -xbox";
$("a.auto-retail").each(function(){var b=$(this);
var a=b.attr("href");
if(a.indexOf(upc)>0){a+="&query="+_afshquery+"&pubIdSuffix=search";
b.attr("href",a)
}})
}};