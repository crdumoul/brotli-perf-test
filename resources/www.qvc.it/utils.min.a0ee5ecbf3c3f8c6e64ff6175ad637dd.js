...
+function(){function a(e){this.rawValue="";
this.values={};
this.SEPARATOR_VALUES="|";
this.SEPARATOR_KEY_VALUE="=";
function b(p){var l=p+"=";
...
}if(o.indexOf(l)==0){n=o.substring(l.length,o.length);
if(n.charAt(0)==='"'){n=n.substring(1,n.length-1)
}n=decodeURIComponent(n).replace(/\+/g," ")
}}return n
}this.rawValue=b(e);
var g=this;
var h=this.rawValue.split(this.SEPARATOR_VALUES);
for(var d=0;
d<h.length;
d++){var j=h[d].split(g.SEPARATOR_KEY_VALUE);
var f=j[0];
var c=decodeURIComponent(j[1]);
g.values[f]=c
}}a.prototype.getValues=function(){return this.values
};
window.CookieHandler=a
}();