...
if ( TM.MetricsCollection && TM.MetricsCollection.version ){
  ...
  TM.MetricsCollection.globalConfig = {
        ...
        TRACKEDTYPES : {
          ...
          'web.captcha.cs_display_error.counter': ['captcha_type', 'fallback_reason', 'is_primary'],
          'web.captcha.display.counter': ['captcha_type', 'timestamp'],
          ...
          'web.page.cs_ism_display_error.counter': ['error_category', 'error_type'],
