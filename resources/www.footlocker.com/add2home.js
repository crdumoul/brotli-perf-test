...
var addToHome = (function (w) {
  var nav = w.navigator,
    ...
    options = {
      ...
      startDelay: 6000,         // 6 seconds from page load before the balloon appears - keeps bubble grounded post-url hiding
      lifespan: 15000,          // 15 seconds before it is automatically destroyed
      bottomOffset: 14,         // Distance of the balloon from bottom
      expire: 131487,           // Minutes to wait before showing the popup again (0 = always displayed) (about 3 months)
...
//      en_us: 'Install this web app on your %device: tap %icon and then <strong>Add to Home Screen</strong>.',
      en_us: 'Install %brand on your %device, tap %icon, and then <strong>"Add to Home Screen</strong>".',
