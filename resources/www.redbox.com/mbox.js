...
mboxFactory = function (_server, _clientCode, _factoryId) {
    ...
    this.addOnLoad(function () {
        _self._pageEndTime = new Date().getTime();
    });
    if (this._supported) {
...
mboxFactory.prototype.setVisitorIdParameters = function (_url, _mboxName) {
    var imsOrgId = 'F7703025512D2C320A490D44@AdobeOrg';
...
mbox.prototype._validateName = function () {
    if (this._name.length > 250) {
        throw "Mbox Name " + this._name + " exceeds max length of " + "250 characters.";
...
if (typeof mboxVersion == 'undefined') {
    ...
    var mboxFactoryDefault = new mboxFactory('redbox.tt.omtrdc.net', 'redbox',
        'default');
};
...
if (mboxGetPageParameter("mboxDebug") != null ||
    ...
    document.write('<' + 'scr' + 'ipt language="Javascript1.2" src=' + '"//admin6.testandtarget.omniture.com/admin/mbox/mbox_debug.jsp?mboxServerHost=redbox.tt.omtrdc.net' + '&clientCode=redbox"><' + '\/scr' + 'ipt>');
};
...
mboxVizTargetUrl = function (_mboxName /*, ... */ ) {
    ...
    _urlBuilder.setBasePath('/m2/' + 'redbox' + '/viztarget');
...
mboxScPluginFetcher.prototype.Fc = function (g, v) {
    ...
    if (!g.match("^(linkInternalFilters|linkTrackVars|linkTrackEvents|linkDownloadFileTypes|visitorNamespace|javascriptVersion|javaEnabled|cookiesEnabled|trackDownloadLinks|linkLeaveQueryString|prop47|prop48|prop3)$"))
        v.addParameter(g, h);
};