...
var s_account = "dtagthrifty2,dtagglobal";
...
s.linkInternalFilters = "javascript:,thrifty.com,gomez.com"
...
function s_doPlugins(s) {
    ...
    /* Capture campaign code only once per visit */
    ...
    //Query Strings capture for Evar25, Evar26, Evar40 and Evar41
    s.eVar27 = s.getQueryParam('rmid');
    s.eVar26 = s.getQueryParam('rrid');

    s.eVar40 = s.getQueryParam('emailaddress');
    s.eVar41 = s.getQueryParam('campid');
    ...
    //event3 automation
    if ((s.prop30 == "thy:res:home") && (s.pageName == "thy:res:rateshop")) {
        s.events = s.apl(s.events, 'event3', ',', 2);
    }
    if ((s.prop30 == "thy:res:home") && (s.pageName == "thy:res:rateshopdetail")) {
        s.events = s.apl(s.events, 'event3', ',', 2);
    }
    if ((s.prop30 == "thy:res:time&place") && (s.pageName == "thy:res:rateshop")) {
        s.events = s.apl(s.events, 'event3', ',', 2);
    }
    if ((s.prop30 == "thy:res:time&place") && (s.pageName == "thy:res:rateshopdetail")) {
        s.events = s.apl(s.events, 'event3', ',', 2);
    }
...
/*s.trackingServer="metric.thrifty.com"
s.trackingServerSecure="metrics.thrifty.com"*/
